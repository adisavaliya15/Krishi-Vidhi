...
import com.example.finale.Adapter.Mandi_District_Adapter;
...
public class Mandi_District_Activity extends MyBaseActivity {
    ListView listView;
    ...
    Mandi_District_Adapter adapter;
    RequestQueue requestQueue;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        LayoutInflater inflater = LayoutInflater.from(this);
        View v = inflater.inflate(R.layout.mandi_district_activity, null, false);
        drawer.addView(v, 0);
        setTitle("શહેર");
...
//                            HashSet hs=new HashSet(Collections.singleton(hero));
                            ...
                            adapter = new Mandi_District_Adapter(heroList, getApplicationContext());
