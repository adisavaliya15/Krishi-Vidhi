...
import com.example.finale.Adapter.Mandi_Details_Adapter;
...
public class Mandi_Details_Activity extends MyBaseActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.mandi_details_activity, null, false);
        drawer.addView(v, 0);
        setTitle("પાક નો ભાવ");
...
//                            HashSet hs=new HashSet(Collections.singleton(hero));
                            ...
                            adapter = new Mandi_Details_Adapter(heroList, getApplicationContext());
