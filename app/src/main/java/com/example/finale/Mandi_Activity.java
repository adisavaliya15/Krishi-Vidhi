...
import com.example.finale.Adapter.Mandi_Adapter;
...
public class Mandi_Activity extends MyBaseActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.mandi_activity, null, false);
        drawer.addView(v, 0);
...
//                            HashSet hs=new HashSet(Collections.singleton(hero));
                            ...
                            adapter = new Mandi_Adapter(heroList, getApplicationContext());
